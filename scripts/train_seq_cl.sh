...
deepspeed --include=localhost:0,1,2,3 --master_port $port training/main.py \
    ...
    --output_dir /mnt/data1/joon/outputs/cl/$cl_method/$model/$repurpose_dim_size/$dataset/ > /mnt/data1/joon/outputs/cl/$cl_method/$model/$repurpose_dim_size/$dataset/train.log 2>&1 &